...
interface MatchScoreRowProps {
  teamA: Team | null;
  teamB: Team | null;
  scoreA: number | string | undefined;
  scoreB: number | string | undefined;
  onChange: (scoreA: number | string, scoreB: number | string | undefined) => void;
  disabled?: boolean;
  tabIndexBase?: number | null;
}
...
export default function MatchScoreRow({
  ...
  disabled = false,
  tabIndexBase = null
}: MatchScoreRowProps): JSX.Element {
  const handleScoreChange = (side: 'a' | 'b', value: string): void => {
