...
// Basado en el Reglamento Oficial FIFA (Annexe C - 495 combinaciones)
// Formato compacto: cada string tiene 8 caracteres representando [1A,1B,1D,1E,1G,1I,1K,1L]

const COMPACT_COMBINATIONS = [
  'EJIFHGLK','HGIDJEFL','EJIDHGLK','EJIDHFLK','EGIDJEFL','EGJDHFLK','EGIDHEFL','EGJDHFLI',
  'EGJDHFIK','HGICJEFL','EJICHGLK','EJICHFLK','EGICJEFL','EGJCHFLK','EGICHEFL','EGJCHFLI',
  'EGJCHFIK','HGICJDLK','CJIDHFLK','CGIDJEFL','CGJDHFLK','CGIDHFLK','CGJDHFLI','CGJDHFIK',
  'EJICHDLK','EGICJDLK','EGJCHDLK','EGICHDLK','EGJCHDLI','EGJCHDIK','CJEDIEFL','CJEDHFLK',
  'CEIDHEFL','CJEDHFLI','CJEDHFIK','CGEDJEFL','CGEDIEFL','CGEDJFLI','CGEDJFIK','CGEDHEFL',
  'CGJDHFLE','CGJDHFEK','CGEDHFLI','CGEDHFIK','CGJDHFEI','HJBFIGLS','EJIBHGLK','EJBFIHLK',
  ...
  'CGBDJFEI','CGBDHFLE','CGBDHFEK','HGBCJFDE','CGBDHFEI','HJIFAGLK','EJIAHELK','EJIFAHLK',
  'EJIFAGLK','EGJFAHLK','EGIFAELK','EGJFAHLI','EGJFAHIK','HJIDAGLK','HJIDAFLK','IGJDAFLK',
  ...
  'HJBFAGLK','HGBAIFLK','HJBFAGLI','HJBFAGIK','EJBAIHLK','EJBAIGLK','EJBAHELK','EGBAIHLK',
